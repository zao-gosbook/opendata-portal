<?php
drupal_add_css(drupal_get_path('module', 'od_common') . '/css/draggable-captcha.css');
?>
...
<div id="draggable-captcha">
  ...
  <div class="captchaWrapper" id="captchaWrapper">
    <a href="<?php print base_path();?>draggable-captcha/<?php print $captcha_sid;?>/refresh/nojs/" class="captchaRefresh use-ajax"><?php print t('Refresh'); ?></a>
    <?php $count = 0;?>
